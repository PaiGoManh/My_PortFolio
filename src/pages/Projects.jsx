...
const Projects = () => {
  return (
    ...
    <div className='md:mt-[7%] mt-[10%]'>
      <h1 className='md:text-right md:mr-[27%] text-left md:mb-[-10px]  mt-3 ml-3 font-bold'>Daapzon <span className='text-xl'>🛒</span> </h1>
      <div className='md:flex md:flex-row flex flex-col justify-center items-center gap-10 mt-5'>
        ...
        <div >
            ...
            <div className='mt-5 text-center'>
              <img src="https://skillicons.dev/icons?i=vite,react,tailwind,solidity" alt="skill-icon" className='w-[100px] mx-40'/>
            </div>
    ...
    <div className='md:mt-[7%] mt-[10%]'>
      <h1 className=' md:ml-[27%] text-left ml-3  md:mb-[-10px] text-l'>Certi Dapp <span className='text-xl'>🎓</span> </h1>
      <div className='md:flex md:flex-row flex flex-col justify-center items-center gap-10 mt-5'>
        <div >
            <p className='w-[400px] text-justify'>
            ...
            <div className='mt-5 text-center'>
              <img src="https://skillicons.dev/icons?i=react,tailwind,solidity" alt="skill-icon" className='w-[100px] mx-40'/>
            </div>
            <div className='flex mt-5 ml-[30%] gap-10'>
                <a href='https://github.com/PaiGoManh/Certificate-DApp_Blockchain' className='flex items-center gap-1'>
                    <h1>Code</h1>
          ...
          <div className='md:mt-[-30px]'>
            <img src={certi} alt='certi' className='border-2 border-black md:w-[500px] md:h-[300px]'/>
        </div>
        </div>
      </div>
      ...
      <div className='mt-[7%]'>
      <h1 className='md:text-right md:mr-[27%] text-left md:mb-[-13px]  mt-3 ml-2 '>Easy Split 💸  </h1>
      <div className='md:flex md:flex-row flex flex-col justify-center items-center gap-10 mt-5'>
        <div className='md:mt-[-30px]'>
            <img src={split} alt='Easy Split' className='border-2 border-black md:w-[500px] h-[300px]'/>
        </div>
        <div className=''>
            <p className='w-[400px] text-justify'>
             ...
             <div className='mt-3 text-center md:ml-[120px]'>
              <img src="https://skillicons.dev/icons?i=mongodb,express,nodejs,react,tailwind" alt="skill-icon" className='w-[200px]'/>
            </div>
            <div className='flex mt-5 ml-[30%] gap-10'>
    ...
    <div className='mt-[8%]'>
      ...
      <div className='md:flex md:flex-row flex flex-col justify-center items-center gap-10 mt-5'>
        <div >
            ...
            <div className='mt-3 text-center md:ml-[160px]'>
              <img src="https://skillicons.dev/icons?i=nextjs,tailwind" alt="skill-icon" className='w-[70px]'/>
            </div>
            <div className='flex mt-5 ml-[30%] gap-10'>
          ...
          <div className='md:mt-[-60px]'>
            <img src={quiz} alt='quiz' className='border-2 border-black w-[500px] h-[300px]'/>
          </div>
        </div>
      </div>
      ...
      <div className='md:flex md:flex-row flex flex-col justify-center items-center gap-10 mt-5'>
        <div className='md:mt-[-120px]'>
            <img src={cinema} alt='nillq'  className='border-2 border-black w-[500px] h-[300px]'/>
        </div>
        <div >
            <p className='w-[400px] text-justify'>
